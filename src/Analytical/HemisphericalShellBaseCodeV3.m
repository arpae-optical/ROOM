...
n2 = 1.463%1.5; % Index of refraction of 2nd medium, chose Pyrex arbitrarily
n3 = 1; % Index of refraction of 3rd medium
r2 = .00015; % outer radius in meters
r1 = r2*.92; % inner radius in meters
lambda0 = 4E-6;%550E-9;% wavelength of incident light in vacuum in meters
k2 = 1.06E-4;%2.918E-5; % absorptive index of medium 2 for use in transmisivity calculation
...
for i = 1:TIRBundleIndexes(1)-1
      ...
      while j <= truncation
          ...
          rho34(j,i) = 0;%leftPortion * rightPortion;
          ...
          %Do another bounce to the substrate. 2 Bounces should lead to
          %almost complete attenuation of initial bundle incidence.
          
          intensitiesToSub(j,i) = BackToSub(j,i)*(rho32(j,i)+(1-rho32(j,i)-rho23_o(j,i))*(tau1(j,i)^2)*(rho21_o(j,i)*rho23_o(j,i)*tau1(j,i)^2)^(j-1));
...
% Do another run through of the bouncing process for beams bounced back
% into the substrate
